...
class StarsGame:
    ...
    def _create_stars(self):
        ...
        x_max = max(0, self.settings.screen_width - star_width)
        y_max = max(0, self.settings.screen_height - star_height)
        for _ in range(500):
            x_position = randint(0, x_max)
            y_position = randint(0, y_max)
